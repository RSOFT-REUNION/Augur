    ...
    <div class="entry-content">
        <form wire:submit="create" enctype="multipart/form-data">
            ...
            <div class="textfield">
                ...
                <input type="text" id="title" wire:model.live="title" name="title" placeholder="Entrez le nom du magasin (ex: AÜGUR - Saint-Pierre)" class="@if($errors->has('title'))textfield-error @endif" value="{{ old('title') }}">
                @if($errors->has('title'))
            ...
            <div class="textfield">
                ...
                <input type="text" id="address" wire:model.live="address" name="address" placeholder="Entrez l'adresse du magasin" class="@if($errors->has('address'))textfield-error @endif" value="{{ old('address') }}">
            ...
            <div class="flex">
                <div class="flex-1 mr-2">
                    <div class="textfield">
                        ...
                        <input type="text" id="address" wire:model.live="city" name="city" placeholder="Entrez la ville" class="@if($errors->has('city'))textfield-error @endif" value="{{ old('city') }}">
                        @if($errors->has('city'))
                ...
                <div class="flex-1 ml-2">
                    <div class="textfield">
                        ...
                        <input type="text" id="postal" wire:model.live="postal" name="postal" placeholder="Entrez le code postal" class="@if($errors->has('postal'))textfield-error @endif" value="{{ old('postal') }}">
            ...
            <div class="textfield">
                ...
                <textarea id="description" wire:model.live="description" placeholder="Entrez une courte description" class="@if($errors->has('description'))textfield-error @endif" value="{{ old('description') }}">{{ old('description') }}</textarea>
