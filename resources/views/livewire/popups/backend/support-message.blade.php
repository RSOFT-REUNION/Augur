        ...
        <form wire:submit.prevent="send" class="mt-4">
            ...
            @if($type == 5)
                <div class="textfield mt-2">
                    ...
                    <input type="text" id="other" wire:model="other" name="other" placeholder="Entrez votre sujet" class="@if($errors->has('other'))textfield-error @endif" value="{{ old('other') }}">
                    @if($errors->has('other'))
            ...
            <div class="textfield mt-2">
                ...
                <textarea wire:model="message" id="message" placeholder="Entrez votre message.">{{ old('message') }}</textarea>
