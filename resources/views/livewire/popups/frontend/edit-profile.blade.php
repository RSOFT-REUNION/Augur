    ...
    <div class="entry-content">
        <form wire:submit.prevent="edit">
            ...
            <div class="flex mt-5">
                <div class="flex-1 mr-1">
                    <div class="textfield">
                        ...
                        <input type="text" id="lastname" wire:model="lastname" name="lastname" placeholder="Entrez votre nom de famille" class="@if($errors->has('lastname'))textfield-error @endif" value="{{ old('lastname') }}">
                ...
                <div class="flex-1 ml-1">
                    <div class="textfield">
                        ...
                        <input type="text" id="firstname" wire:model="firstname" name="firstname" placeholder="Entrez votre prénom" class="@if($errors->has('firstname'))textfield-error @endif" value="{{ old('firstname') }}">
            ...
            <div class="textfield mt-2">
                ...
                <input type="password" id="password" wire:model="password" name="password" placeholder="Modifier votre mot de passe" class="@if($errors->has('password'))textfield-error @endif">
                @if($errors->has('password'))
                    <p class="text-input-error">{{ $errors->first('password') }}</p>
                @endif
            </div>
            <div class="mt-5">
                <input type="checkbox" wire:model="newsletter" id="newsletter" @if($me->newsletter) checked @endif>
