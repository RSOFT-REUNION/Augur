    ...
    ------------------------------------- */
        ...
        @media all {
            .btn-primary table td:hover {
                background-color: #f5eb69 !important;
            }
            .btn-primary a:hover {
                background-color: #f5eb69 !important;
                border-color: #f5eb69 !important;
            }
        }
    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Vous avez reçu une nouvelle commande</span>
                    ...
                    <tr>
                        <td class="wrapper">
                            <p class="align-center">
                                <img  style="width: 200px;" src="{{ asset('frontend/images/logo/logo_gris.png') }}" alt="Logo">
                            </p>
                                ...
                                <tr>
                                    <td align="left">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <th class="content-block">E-mail :</th>
                                                <td>{{ $data['email'] }}</td>
                                            </tr>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">Augur Réunion - 0693 66 18 92</span>
                            </td>
                        </tr>
                    </table>
                </div>
