        ...
        <div class="container mx-auto">
            <div class="flex items-center">
                ...
                <div class="flex-none">
                    ...
                    <a onclick="Livewire.dispatch('openModal', { component: 'popups.frontend.search' })" class="mr-2 btn-icon_transparent cursor-pointer"><i class="fa-solid fa-magnifying-glass"></i></a>
