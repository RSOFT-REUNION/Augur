    ...
    <header id="front-header">
        <div class="container mx-auto">
            <div class="flex items-center">
                ...
                <div class="flex-none">
                    <a href="{{ route('fo.home') }}" class="mr-2 btn-icon_transparent @if($active == 'home') active @endif">Accueil</a>
                    <a href="{{ route('fo.about') }}" class="mr-2 btn-icon_transparent @if($active == 'about') active @endif">Qui sommes-nous ?</a>
                    <a href="{{ route('fo.labels.list') }}" class="mr-2 btn-icon_transparent @if($active == 'label') active @endif">Nos labels</a>
                    <a href="" class="mr-2 btn-icon_transparent">Nos produits</a>
                    <a href="{{ route('fo.evenements') }}" class="mr-2 btn-icon_transparent @if($active == 'evenement') active @endif">Nos animations</a>
