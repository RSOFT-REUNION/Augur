        ...
        <div class="col">
            <div class="card border-left-primary shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route($category->exists ? 'backend.content.categories.update' : 'backend.content.categories.store', $category) }}" method="post"  class="mt-6 space-y-6">
                        @csrf
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-3">
                        <button type='button' class="btn btn-danger" onclick="location.href='{{ route('backend.content.categories.index') }}'">
