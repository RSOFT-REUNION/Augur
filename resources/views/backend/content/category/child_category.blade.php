...
@foreach ($child_category->categories as $childCategory)
    ...
    @include('backend.layouts.modal-delete', ['id' => $childCategory->id, 'title' => 'Êtes-vous sûr de vouloir supprimer '.$childCategory->name.' et toutes les sous categories ?', 'route' => 'backend.content.categories.destroy'])
@endforeach
