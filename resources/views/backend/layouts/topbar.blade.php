<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1 d-flex align-items-center">
            <a class="btn btn-warning nav-link" style="height: 40px; color: #FFFFFF;" href="{{ route('index') }}" target="_blank" id="viewsite" role="button" aria-haspopup="true" aria-expanded="false" >
