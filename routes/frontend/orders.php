...
Route::post('/payment_success', [OrdersController::class, 'orderValidated'])->name('orders.success');
Route::post('/payment_failed', [OrdersController::class, 'orderFailed'])->name('orders.failed');
