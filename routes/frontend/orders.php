...
Route::get('/payment_success', [OrdersController::class, 'orderValidated'])->name('orders.success');
Route::get('/payment_failed', [OrdersController::class, 'orderFailed'])->name('orders.failed');
